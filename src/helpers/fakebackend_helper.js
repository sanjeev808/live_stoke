...
const baseUrl = "https://stgn.appsndevs.com/snapcident/users";
...
//getuser 
// export const getUser = get(url.USER_DATA);
export const getUser =()=>get(`${baseUrl}/userList?sort=-1&pageNumber=1&recordsLimit=10`);
